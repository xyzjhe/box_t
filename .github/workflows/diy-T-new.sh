...
sed -i 's#"app_source"><#"app_source">https://agit.ai/laozou/laoliubei/raw/branch/main/xiaopingguo.json<#g' $CURRENT_DIR/$DIR/app/src/main/res/values-zh/strings.xml
